...
O sadismo não é apenas uma concepção inteiramente outra que aquela que existia antes de Sade. Aparece de um lado, positivamente, como "irrupção das forças excremenciais" e de outro, como uma "limitação correspondente", uma "subserviência estreita de tudo o que opomos a essa irrupção", ou seja, nós somos subservientes a tudo aquilo que nós utilizamos para nos opor a essas irrupções.
