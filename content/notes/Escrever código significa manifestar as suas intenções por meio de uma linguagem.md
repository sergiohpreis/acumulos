...
Penso que **escrever código é manifestar as suas intenções por meio de uma linguagem**, podendo ser ela uma linguagem de baixo nível, ou agora, com a chegada da programação agêntica, podendo ser também linguagem natural. Imagino que isso se deu através de um percurso ([[O desenvolvimento da profissão do programador ao longo do tempo]]).

Concordo com o que diz [[AKITA Fábio. AI Agents - Qual seria a melhor Linguagem de Programação para LLMs? (2016)]]:
