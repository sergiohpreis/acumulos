...
## A busca pela essência da técnica

Nesse texto, o objetivo de Heidegger é questionar a técnica para preparar uma "livre relação" com ela

> *A relação é livre se abrir nossa **existência** (Dasein) a **essência** da técnica. Caso correspondamos a essência, estaremos aptos a experimentar o técnico (das Technische) em sua delimitação*
> (P34)

> [!info] [[O significado de "Dasein"]]

Para Heidegger, a essência da técnica não é algo técnico. Se considerarmos a técnica como algo neutro não seremos capazes de compreender a essência da técnica.

> [!info] Conceito tradicional de essência
> De acordo com Heidegger, "A essência de algo vale, segundo antiga doutrina, pelo que **algo é**"

## A tradicional determinação instrumental e antropológica da técnica

O conceito tradicional de técnica pode ser expresso através de duas determinações correlacionadas:
- um meio para fins
- um fazer do homem

A técnica é uma instalação (instrumentum), pois aprontam-se e empregam-se instrumentos, aparelhos e máquinas para as necessidades e fins a que servem

A essa concepção corrente de técnica, pode-se chamar de determinação **instrumental e antropológica** da técnica
> A concepção corrente de técnica, segunda a qual ela é um **meio** e um **fazer** humano
> (P36)

Heidegger considera que essa concepção não só é correta, como define a técnica moderna, que é portanto, "um meio para fins". (exemplos de técnicas modernas na P36)

Heidegger afirma a existência de um "querer-dominar" do homem para com a técnica, algo como uma busca por "uma correta relação com a técnica"
> Tudo se reduz ao **lidar de modo adequado** com a técnica enquanto meio (P37)
