...
- Descartes: leitura concluída (Discurso e Meditações)
- Kant: leitura em andamento (Prolegômenos)
- Yuk Hui: leitura parcial de [[HUI Yuk. Tecnodiversidade (2020)]], sem anotações estruturadas
- Marx: reflexões conceituais em andamento (ver [[Fetichismo da mercadoria e a produção de software]], [[A alienação do trabalho representa uma ruptura]], [[Crescimento anárquico dos sistemas tecnológicos]], [[Monopólios da informação]])
...
- [[A alienação do trabalho representa uma ruptura]]
